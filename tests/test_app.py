...
from app import format_time, truncate_filter, time_diff_filter, inject_config
...
class TestAppRoutes:
    ...
    def test_epg_display_page(self, client, mock_webepg_client, sample_channels, sample_programs):
    ...
    def test_mapping_page(self, client, mock_webepg_client, mock_ultimate_backend_client,
                          sample_channels, sample_providers):
    ...
    def test_api_get_channel_programs(self, client, mock_webepg_client, sample_programs):
        """Test API endpoint for getting channel programs."""
        mock_webepg_client.get_channel_programs.return_value = sample_programs

        response = client.get('/api/channels/channel1/programs?start=2024-01-01T00:00:00Z&end=2024-01-02T00:00:00Z')
    ...
    def test_api_get_providers(self, client, mock_ultimate_backend_client, sample_providers):
    ...
    def test_api_create_alias_success(self, client, mock_webepg_client):
        ...
        response = client.post('/api/mapping/create-alias',
                               data=json.dumps(data),
                               content_type='application/json')
    ...
    def test_500_error_handler(self, client, mock_webepg_client):
        ...
        with patch('app.webepg_client.get_channels', side_effect=Exception("Internal Error")):
            response = client.get('/epg')
