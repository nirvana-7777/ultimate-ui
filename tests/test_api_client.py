...
class TestWebEPGClient:
    ...
    def test_get_health_success(self, client, mock_adapter):
        ...
        mock_adapter.get('http://test-webepg:8080/api/v1/health',
                         status_code=200)
    ...
    def test_get_channels_success(self, client, mock_adapter, sample_channels):
        ...
        mock_adapter.get('http://test-webepg:8080/api/v1/channels',
    ...
    def test_get_channel_success(self, client, mock_adapter, sample_channels):
        ...
        mock_adapter.get('http://test-webepg:8080/api/v1/channels/channel1',
                         json=channel,
                         status_code=200)
    ...
    def test_get_channel_not_found(self, client, mock_adapter):
        ...
        mock_adapter.get('http://test-webepg:8080/api/v1/channels/nonexistent',
                         status_code=404)
    ...
    def test_get_channel_programs_success(self, client, mock_adapter, sample_programs):
        ...
        mock_adapter.get('http://test-webepg:8080/api/v1/channels/channel1/programs',
    ...
    def test_get_providers_success(self, client, mock_adapter):
        ...
        mock_adapter.get('http://test-webepg:8080/api/v1/providers',
                         json=providers,
                         status_code=200)
    ...
    def test_create_provider_success(self, client, mock_adapter):
        ...
        mock_adapter.post('http://test-webepg:8080/api/v1/providers',
                          json=provider_data,
                          status_code=201)
    ...
    def test_create_channel_alias_success(self, client, mock_adapter):
        ...
        mock_adapter.post('http://test-webepg:8080/api/v1/channels/channel1/aliases',
                          json=alias_data,
                          status_code=201)
    ...
    def test_get_import_status_success(self, client, mock_adapter):
        ...
        mock_adapter.get('http://test-webepg:8080/api/v1/import/status',
                         json=status_data,
                         status_code=200)
    ...
    def test_trigger_import_success(self, client, mock_adapter):
        ...
        mock_adapter.post('http://test-webepg:8080/api/v1/import/trigger',
                          json=result_data,
                          status_code=200)
    ...
    def test_get_statistics_success(self, client, mock_adapter):
        ...
        mock_adapter.get('http://test-webepg:8080/api/v1/statistics',
                         json=stats_data,
                         status_code=200)
    ...
    def test_get_statistics_fallback(self, client, mock_adapter, sample_channels, sample_programs):
...
class TestUltimateBackendClient:
    ...
    def test_get_providers_success(self, client, mock_adapter, sample_providers):
        """Test getting providers successfully."""
        mock_adapter.get('http://test-ultimate:3000/api/providers',
    ...
    def test_get_provider_channels_success(self, client, mock_adapter, sample_channels):
        ...
        mock_adapter.get('http://test-ultimate:3000/api/providers/provider1/channels',
                         json=sample_channels,
                         status_code=200)
    ...
    def test_get_all_channels_success(self, client, mock_adapter, sample_providers, sample_channels):
        ...
        mock_adapter.get('http://test-ultimate:3000/api/providers/provider2/channels',
